...
namespace LogicXCFMS.Model
{
    ...
    public partial class Ref_Product_Types
    {
        ...
        public Ref_Product_Types()
        {
            ...
            this.Ref_Product_Types1 = new HashSet<Ref_Product_Types>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Ref_Product_Types> Ref_Product_Types1 { get; set; }
        public virtual Ref_Product_Types Ref_Product_Types2 { get; set; }
    }
}
